...
import { FaFacebook, FaWhatsapp, FaInstagram, FaEnvelope, FaCcVisa, FaCcMastercard } from 'react-icons/fa';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 mb-4">Budite u toku s najnovijim ponudama i akcijama</p>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <p>Ulica Stjepana i Antuna Radića 37,</p>
              <p>44 000, Sisak</p>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/usluge" className="hover:text-pink-500 transition-colors">
                  Usluge
                </Link>
              </li>
              <li>
                <Link href="/katalog" className="hover:text-pink-500 transition-colors">
                  Katalog
                </Link>
              </li>
              <li>
                <Link href="/cjenik" className="hover:text-pink-500 transition-colors">
                  Cjenik
                </Link>
              </li>
              <li>
                <Link href="/o-nama" className="hover:text-pink-500 transition-colors">
                  O nama
                </Link>
              </li>
            </ul>
