    ...
    <section style={{ background: 'linear-gradient(to top, #e5e7eb, #ffffff)' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 text-center">
          <Link
            href="/usluge"
            className="inline-flex items-center px-8 py-4 text-base font-medium rounded-xl shadow-lg text-white bg-slate-800 hover:bg-slate-700 transition-all duration-300 hover:shadow-xl border border-slate-600"
          >
